...
Обратите внимание: проверка на X-Telegram-Bot-Api-Secret-Token вырезана из текущей версии и поддерживается только с node-telegram-bot-api v0.64 +
Проверку можно легко дописать при необходимости в setupExpress() в index.js.
